...
- Robustness Design
Capture global errors via React error boundary, display degraded UI on crash and provide retry button.

## Run
Clone
```
git clone https://github.com/luxihuii/react-ts-music.git
```
Install
```
npm install
